...
const values = [
  { icon: Target, title: "Our Mission", description: "To empower organizations with expertly crafted templates and tools that streamline operations, enhance decision-making, and drive sustainable growth." },
  { icon: Eye, title: "Our Vision", description: "To be Africa's leading provider of business operating systems — setting the standard for operational excellence and innovation." },
  { icon: Heart, title: "Our Values", description: "Excellence, integrity and customer-centricity guide everything we do. We build solutions that make a real difference." },
];

const team = [
  { name: "Samuel Mukasa", role: "Founder & CEO", initials: "SM" },
    ...
    <>
      ...
      <section className="bg-surface py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <FadeIn delay={0.3}>
            <figure className="gradient-brand relative mx-auto mt-16 max-w-3xl overflow-hidden rounded-2xl p-10 text-center shadow-elevated sm:p-12">
              <div className="texture-dots absolute inset-0 opacity-30" aria-hidden />
              <Quote className="relative mx-auto h-8 w-8 text-accent" />
              <blockquote className="relative mt-5 font-heading text-xl leading-relaxed text-white sm:text-2xl">
                &ldquo;Every organization — regardless of size or industry —
                deserves access to professional tools that drive clarity,
                efficiency and growth.&rdquo;
              </blockquote>
              <figcaption className="relative mt-5 text-sm font-semibold text-accent-light">
                Samuel Mukasa · Founder &amp; CEO
              </figcaption>
            </figure>
          </FadeIn>
        </div>
