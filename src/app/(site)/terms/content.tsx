...
const sections = [
  { id: "acceptance", title: "1. Acceptance of Terms", content: "By accessing or using the TrueWorks Ventures website and purchasing our products, you agree to be bound by these Terms of Service. If you do not agree, please do not use our services." },
  ...
  { id: "refunds", title: "5. Refund and Exchange Policy", content: "We offer a 4-day satisfaction guarantee. If a template does not meet your needs, request a return from your order within 4 days of purchase and our team will review it or make it right." },
  ...
  { id: "ip", title: "7. Intellectual Property", content: "All templates, dashboards, designs, and content on this website are the intellectual property of TrueWorks Ventures unless otherwise stated. Unauthorized reproduction or distribution is prohibited." },
  ...
  { id: "liability", title: "9. Limitation of Liability", content: "TrueWorks Ventures shall not be liable for any indirect, incidental, or consequential damages arising from the use or inability to use our products. Our total liability shall not exceed the amount paid for the product in question." },
