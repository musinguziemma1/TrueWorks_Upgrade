...
const ACTION_COLORS: Record<string, string> = {
  ...
  mfa_disabled: "bg-slate-50 text-slate-700 border-slate-200",
                        ...
                        return (
                          <div key={s._id} className="flex items-center gap-4 p-4 hover:bg-muted/30 transition-colors">
                            <div className={cn(
                              ...
                              status === "active" ? "bg-emerald-50" : status === "revoked" ? "bg-red-50" : "bg-slate-50"
                            )}>
                        ...
                        <div key={e._id} className="flex items-center gap-4 p-4 hover:bg-muted/30 transition-colors">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                              ...
                              <Badge variant="outline" className={cn("text-[10px] px-1.5 py-0", ACTION_COLORS[e.action] ?? "bg-slate-50 text-slate-700 border-slate-200")}>
                                {e.result}
                              </Badge>
                            </div>
