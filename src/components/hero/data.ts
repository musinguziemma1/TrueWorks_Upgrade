...
export const heroSlides: SlideData[] = [
  {
    ...
    kpis: [
      ...
      { label: 'Operating Margin', value: '18.5%', change: '+5.2%', trend: 'up', color: '#D4A64A' },
  ...
  },
  {
    ...
    kpis: [
      ...
      { label: 'Process Automation', value: '87%', change: '+23%', trend: 'up', color: '#D4A64A' },
  ...
  },
  {
    ...
    kpis: [
      ...
      { label: 'Bed Utilization', value: '89.3%', change: '+12%', trend: 'up', color: '#D4A64A' },
  ...
  },
  {
    ...
    kpis: [
      ...
      { label: 'Production Yield', value: '96.8%', change: '+5.3%', trend: 'up', color: '#D4A64A' },
  ...
  },
  {
    ...
    kpis: [
      ...
      { label: 'Citizen Satisfaction', value: '88.2%', change: '+12.7%', trend: 'up', color: '#D4A64A' },
