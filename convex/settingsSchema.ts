...
export const SETTING_FIELDS: SettingField[] = [
  ...
  { key: "taxRate", tab: "payment", type: "number", label: "Tax Rate (%)", default: 18, min: 0, max: 100, step: 0.5, status: "planned" },
  ...
  { key: "mtnMomoEnabled", tab: "payment", type: "boolean", label: "MTN Mobile Money", description: "Direct MTN MoMo payments (planned)", default: true, status: "planned" },
  { key: "airtelMoneyEnabled", tab: "payment", type: "boolean", label: "Airtel Money", description: "Direct Airtel payments (planned)", default: true, status: "planned" },
  { key: "paypalEnabled", tab: "payment", type: "boolean", label: "PayPal", description: "PayPal payments (planned)", default: false, status: "planned" },
  ...
  // ─── Security ───────────────────────────────────────────────────────────
  { key: "require2fa", tab: "security", type: "boolean", label: "Two-Factor Authentication (2FA)", description: "Require 2FA for admin account access", default: false, status: "planned" },
  { key: "passwordExpiryDays", tab: "security", type: "number", label: "Password Expiry (days)", default: 90, min: 0, max: 730, status: "planned" },
  { key: "sessionTimeoutMinutes", tab: "security", type: "number", label: "Session Timeout (minutes)", default: 60, min: 5, max: 1440, status: "planned" },
  { key: "maxLoginAttempts", tab: "security", type: "number", label: "Max Login Attempts", default: 5, min: 1, max: 50, status: "planned" },
