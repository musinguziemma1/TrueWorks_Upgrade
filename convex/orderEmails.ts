...
<body style="font-family: 'Segoe UI', 'Segoe UI Variable', 'Noto Sans', Arial, sans-serif; background: #F4F6FA; padding: 32px; color: #2A3548;">
  <div style="max-width: 560px; margin: 0 auto; background: #ffffff; border-radius: 12px; padding: 32px;">
    ...
    <div style="background: #F4F6FA; border: 1px solid #E2E7EE; border-radius: 8px; padding: 16px; margin: 16px 0;">
    ...
    <p style="margin: 24px 0 0; font-size: 12px; color: #5D6B7E;">TrueWorks Ventures — Kampala, Uganda</p>
  </div>
</body></html>`;
