...
const base = path.join(here, "..", "public", "images");
...
const images = [
  ...
  { file: path.join("industries", "finance.webp"), w: 1600, h: 900, from: "#04101F", via: "#0B2545", to: "#8FB3CC" },
  { file: path.join("industries", "education.webp"), w: 1600, h: 900, from: "#04101F", via: "#1C4A7E", to: "#3E6990" },
  { file: path.join("industries", "sme.webp"), w: 1600, h: 900, from: "#04101F", via: "#123663", to: "#DAA520" },
];
